	...
	<section>
		...
		<div class="benefit-items">
			<div class="row" margin-top:150px;">
				<c:forEach items="${updateList }" var="account" varStatus="loop">
				<div style="margin-top: 30px;float:left;" class="col-lg-4 col-sm-6" class="accountlist">
					<div class="single-benefit">
						<div class="sb-text">
							<h4><a href="<%=request.getContextPath()%>/account/updateForm.do?accountNo=${account.no}&nickName=${account.nickName}"
							style="color : #00075e;"
							>통장별칭 : 
							<c:out value="${account.nickName}" /></a></h4>
