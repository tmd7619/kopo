			...
			<div class="row">
				...
				<div style="margin-top: 30px;float:left;" class="col-lg-4 col-sm-6" class="accountlist">
					<div class="single-benefit">
						<div class="sb-text">
							<h4><a href="<%=request.getContextPath()%>/account/otherBankTransactionDetail.do?accountNo=${account.no}"
							style="color : #00075e;">
							통장별칭 : <c:out value="${account.nickName}" /></a></h4>
